...
const ExpandedTilePitch = (props: any) => {
  ...
  return (
    <>
      <div className="w-[78%] h-[98vh] my-[1vh] bg-white flex flex-col items-center  justify-center rounded-2xl overflow-y-scroll">
        <div className="h-fit w-[900px] rounded-2xl shadow-2xl mt-10">
